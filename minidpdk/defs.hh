...
// MiniDPDK shim for DPDK's packet-type (RTE_PTYPE_*) and Rx/Tx offload
// (RTE_ETH_*_OFFLOAD_*) definitions the ENA driver references.

#include <minidpdk/rte_bitops.h>     // RTE_BIT64
                                    #define RTE_VERSION (0x0001)
...
/* Link status (rte_eth_link.link_status / link_duplex) */
#define RTE_ETH_LINK_DOWN          0
#define RTE_ETH_LINK_UP            1
#define RTE_ETH_LINK_FULL_DUPLEX   1

/* Link speed capabilities (rte_eth_link.link_speeds / speed_capa bitmap) */
...
/* Numeric link speed in Mbps (rte_eth_link.link_speed) */
